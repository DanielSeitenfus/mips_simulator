# Organização de Computadores - Trabalho 1
# Aluno: Nikolas Machado Corrêa
# Matrícula: 201710014 - CC1
...
main:
	imprime_str("Endereço   Código     Instrução\n")
	addiu  $sp, $sp, -8  	     # reserva espaço na pilha pra variáveis
				     # Abertura do arquivo:
...
Fim_Arquivo: 		    	    # leitura das instruções
